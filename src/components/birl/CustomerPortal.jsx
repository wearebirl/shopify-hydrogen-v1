...
export function CustomerPortal(customer) {
    ...
    return (
        ...
        <div className={`${styles} customer-portal-container`}>
                ...
                <div className="customer-panel-top">
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M9 22V12H15V22M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke="#667085" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <span>Orders</span>
                    </button>
                    <button>
            ...
            <div className="customer-portal-body">
                ...
                <span className="icon-menu">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M15 12.5L10 7.5L5 12.5" stroke="#667085" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </span>
                ...
                <div className="customer-portal-breadcrumb">
                    ...
                    <svg  className="arrow-right" xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                        <path d="M1 11L6 6L1 1" stroke="#98A2B3" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    ...
                    <div className="birl-product-cta-container">
                        <img loading="eager" src={birlLogo} width="56" height="19" alt="Birl Logo"/>
                            <div className="birl-product-cta-text">
                                <p>
                                    { block.settings.text_value == "Option #1" &&
                                        <>
                                        <span>Trade-in your pre-owned items and receive money off today
                                            <span className="product-cta-links"><button onClick="openDropdown()">Learn more</button>
                                                <img loading="eager"  src={arrowRight} alt="Arrow" width="16" height="16" />
                                            </span>
                                        </span>
                                        </>
                                    }
                                    {block.settings.text_value == "Option #2" &&
                                        <>
                                        <span>Have a DAWN item you’ve bought from elsewhere
                                            <span className="product-cta-links"><button onClick="openDropdown()">Click here</button>
                                                <img loading="eager" src={arrowRight} alt="Arrow" width="16" height="16" />
                                            </span>
                                        </span>
                                        </>
