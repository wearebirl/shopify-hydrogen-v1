...
export function CustomerPortals(customer) {
        ...
        <div className="customer-portal-body">
          ...
          <div className="customer-orders">
            ...
            <div className="customer-order-mobile">
              ...
              <div>
                <p>
                  Amount <span className="mobile-bold">£250</span>
                </p>
                <p>
                  # of item(s) <span className="mobile-bold">2</span>
                </p>
                <p>
                  Tracking <span className="mobile-bold">3Y5J8Z1R6K0X2A9</span>
                </p>
                <p>
                ...
                <p>
                  Birl trade-in{' '}
                  <span className="status-text--Eligible">
                    <span>Eligible</span>
                  </span>{' '}
                </p>
