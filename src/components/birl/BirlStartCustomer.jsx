                            ...
                            <div className={"mt-[30%] ml-[30px]"}>
                                ...
                                {Customer ?
                                    ...
                                    <div className="birl-guest-welcome-buttons -[15px]">
                                        ...
                                        <Link to={'/account'}>
                                            <div
                                                className="birl-button border border-gray-300 rounded-[10px] px-[20px] py-[20px] mb-[15px] mt-1 text-left">
                                                <div className={"flex flex-row "}>
                                                    <span
                                                        className={"font-semibold"}>Bought an item through the {StoreName} online store?</span>
                                                    <Image loading="eager" src={frowardArrow} className="arrow-welcome"
                                                           width="11" height="8"/>
                                                </div>
                                                <div className={"text-sm"}>
                                                    Choose this option if you have previously bought through the website
                                                    and would like to access your orders to trade-in
                                                </div>
                                        ...
                                        <Link to={'/birl/trade-in'}>
                                            <div
                                                className="birl-button border border-gray-300 rounded-[10px] px-[20px] py-[20px] mb-1 text-left">
                                                <div className={"flex flex-row "}>
                                                ...
                                                <div className={"text-sm"}>
                                                    Choose this option if you have previously bought an item in store or
                                                    through another online {StoreName} stockist
                                                </div>
                                    ...
                                    <div className="birl-guest-welcome-buttons ">
                                        <Link to={'/account/'}>
                                            <div
                                                ...
                                                <div className={"flex flex-row "}>
                                                    <span
                                                        className={"font-semibold"}>Sign in to your {StoreName} account</span>
                                                    <Image loading="eager" src={frowardArrow} className="arrow-welcome"
                                                           width="11" height="8"/>
                                                </div>
                                                <div className={"text-sm"}>
                                                    Access your orders to see which previously purchased items are
                                                    eligible for trading in with Birl
                                                </div>
                                            </div>
                                        </Link>
                                        ...
                                        <Link to={"/account/register/"}>
                                            <div
                                                className="birl-button border border-gray-300 rounded-[10px] px-[20px] py-[20px] space-y-0.5 text-left"

                                            >
                                                <div className={"flex flex-row "}>
                                                    <span
                                                        className={"font-semibold"}>Create a {StoreName} account</span>
                                                    <Image loading="eager" src={frowardArrow} className="arrow-welcome"
                                                           width="11" height="8"/>
                                                </div>
                                                <div className={"text-sm"}>
                                                    Create an account with {StoreName} in order to use Birl to trade-in
                                                    a preowned {StoreName} item.
                                                </div>
                    ...
                    <div className={"relative"}>
                        ...
                        <div className={"mt-[30%] ml-[30px]"}>
                            ...
                            <p className="welcome-description mb-[20px]">
                                ...
                                {Customer ?
                                    <>
                                        Sorry, We are unable to begin trade-in process for you at this time.
                                    </>
                                    :
                                    <>
                                        In order to proceed with your trade in you will need to have an account
