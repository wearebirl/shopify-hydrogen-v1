...
import {
    BirlBanner,
    BirlHeading,
    ConditionSelection, ContactDetails,
    TradeInProgressBar
...
function AuthenticatedAccount({
    ...
    return (
        <Layout>
            <Suspense>
                <Seo type="noindex" data={{title: 'Contact Details'}} />
            </Suspense>
            <BirlBanner></BirlBanner>
            <BirlHeading headingText={"Contact Detaisls"}></BirlHeading>
            <TradeInProgressBar currentStep={4}></TradeInProgressBar>
            <ContactDetails customer={customer} address={defaultAddress}></ContactDetails>
        </Layout>
    );
}
