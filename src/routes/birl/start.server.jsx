...
import BirlWelcome from "./index.server";
import {BirlStartCustomer} from "../../components/birl";
...
function LoggedOutStat() {

    return (

        <BirlStartCustomer Customer={null} StoreName={"Hydrogen-1"}></BirlStartCustomer>
    )
}
