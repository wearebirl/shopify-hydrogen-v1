...
export function CartModalPopup() {
        ...
        <div className="cart-modal-popup-container">
            <div className="cart-modal-popup-content">
                ...
                <div className="popup-item">
                    <img className="popup-item-image" loading="eager" rc="https://placehold.co/70x70" alt="product image"  width="80" height="80" />
                ...
                <div className="birl-credit-container">
                    ...
                    <div className="birl-credit-header">
                        <div>
                            <img loading="eager"  src="{{ 'birl-logo.png' | asset_url }}" alt="Birl Logo" width="56" height="19" />
